        ...
        <div class="w-1/2 bg-white rounded shadow-2xl p-8 m-4">
            ...
            <form action="/users/{{$user->id}}" method="POST">
                ...
                <div class="flex flex-col mb-4">
                    ...
                    <input class="border py-2 px-3 text-grey-800" type="text" name="name" id="name" value="{{ $user->name }}">
                </div>
                <div class="flex flex-col mb-4">
                    <label class="mb-2 font-bold text-lg text-gray-900" for="email">Email</label>
                    <input class="border py-2 px-3 text-grey-800" type="email" name="email" id="email" value="{{ $user->email }}">
                </div>
                <div class="flex flex-col mb-4">
                    <label class="mb-2 font-bold text-lg text-gray-900" for="phone">Phone</label>
                    <input class="border py-2 px-3 text-grey-800" type="text" name="phone" id="phone" value="{{ $user->phone }}">
                </div>
                <div class="flex mb-4">
                  <button class="block bg-blue-500 hover:bg-blue-600 text-white uppercase text-lg mx-auto py-2 px-4 rounded" type="submit">update</button>
